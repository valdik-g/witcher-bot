...
module RemoveKvest
  ...
  def remove_passport_kvest(message, bot, user, passport_id)
    ...
    if kvest.nil?
      ...
      if kvest.title_id
        title = Title.find_by(id: kvest.title_id)
